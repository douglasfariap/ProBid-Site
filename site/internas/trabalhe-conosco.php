...
?>
<script type="text/javascript" src="/validaArquivo.js"> </script>
<div class="internalContent">
    <form method="post" enctype="multipart/form-data">
        <div class="contentLeft">
          ...
          <input name="fileOriginal" type="file" size="50" id="fileOriginal" onchange="document.getElementById('fileFalso').value = this.value;"/>
        </div></div>
                           
                            <div  class="formulario">
                                <label for="mensagem">Mensagem</label>
                                <textarea  id="mensagem" name="mensagem" rows="3" cols="50"></textarea>
                            </div>
