<div class="internalContent"><div class="contentLeft"><table width="722" cellspacing="0" cellpadding="0">
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#ffffff"><h2 class="ttInternas">FALE CONOSCO</h2><span style="width:80%" class="detalhe"></span>
        <p class="txtParceiros">Nossa estrutura de consultoria está permanentemente envolvida em novas iniciativas e projetos, voltados à ampliação de nosso portfólio de soluções e serviços. Fale conosco e fique atualizado sobre o que a ProBid está desenvolvendo e executando para o setor público.</p>
...
<input class="texto" id="telefone" type="text" name="telefone" />
    ...
    <div class="formulario">
      ...
      <input class="texto" id="assunto" type="text" name="nome" />
    </div>
    <div  class="formulario">
...
</table></div><div class="contentRight"></div></div>